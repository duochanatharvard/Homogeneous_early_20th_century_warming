% out_var = HM_function_get_pairs(in_var,index,lon_index,lat_index,time_index,reso_s,reso_t,x_lim,y_lim,t_lim,mode)
...
function [out_var,out_index] = HM_function_get_pairs(in_var,index,lon_index,lat_index,time_index,reso_s,reso_t,c_lim,y_lim,t_lim,mode)

    in_lon = in_var(lon_index,:);
    in_lat = in_var(lat_index,:);

    [var_grd,id_grd] = HM_function_pnt2grd_3d (in_lon,in_lat,[],in_var,index,reso_s,reso_s,[],2,[]);
