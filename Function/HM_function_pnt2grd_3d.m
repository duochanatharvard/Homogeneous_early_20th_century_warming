% [var_grd,id_grd] = HM_function_pnt2grd_3d(in_lon,in_lat,in_day,in_var,in_id,reso_x,reso_y,reso_t,mode,tname)
function [var_grd,id_grd] = HM_function_pnt2grd_3d(in_lon,in_lat,in_day,in_var,in_id,reso_x,reso_y,reso_t,mode,tname)

    % in_lon (in_lon < 0) =  in_lon (in_lon < 0) + 360;
