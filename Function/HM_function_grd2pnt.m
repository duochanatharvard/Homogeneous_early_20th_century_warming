% out_pnts = HM_function_grd2pnt(in_lon,in_lat,in_dy,in_grd,reso_x,reso_y,reso_t)
...
function out_pnts = HM_function_grd2pnt(in_lon,in_lat,in_dy,in_grd,reso_x,reso_y,reso_t)
