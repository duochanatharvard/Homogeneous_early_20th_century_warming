function var_clim = HM_lme_var_clim(x1,x2,y1,y2,t1,t2,mt,varname,env)
    ...
    dir_load = [HM_OI('home',env),HM_OI('mis',env)];
    ...
    var_1 = HM_function_grd2pnt(x1,y1,mt,VAR_lon,0.25,0.25,1);
    var_1_2 = HM_function_grd2pnt(x1,y1,mt,VAR_lon_2,2,2,1);
    var_1(isnan(var_1)) = var_1_2(isnan(var_1));

    var_2 = HM_function_grd2pnt(x2,y2,mt,VAR_lon,0.25,0.25,1);
    var_2_2 = HM_function_grd2pnt(x2,y2,mt,VAR_lon_2,2,2,1);
    ...
    gr_lon = HM_function_grd2pnt(mx,my,mt,GR_lon,0.25,0.25,1);
    gr_lon_2 = HM_function_grd2pnt(mx,my,mt,GR_lon_2,2,2,1);
    gr_lon(isnan(gr_lon)) = gr_lon_2(isnan(gr_lon));

    gr_lat = HM_function_grd2pnt(mx,my,mt,GR_lat,0.25,0.25,1);
    gr_lat_2 = HM_function_grd2pnt(mx,my,mt,GR_lat_2,2,2,1);
    gr_lat(isnan(gr_lat)) = gr_lat_2(isnan(gr_lat));

    gr_tim = HM_function_grd2pnt(mx,my,mt,GR_tim,0.25,0.25,1);
    gr_tim_2 = HM_function_grd2pnt(mx,my,mt,GR_tim_2,2,2,1);
