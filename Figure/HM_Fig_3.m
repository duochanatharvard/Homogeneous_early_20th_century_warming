...
if strcmp(varname,'SST')
    ...
    other_ds = load(file_mis,'hadnmat2');
end
...
for reg = 1:2
    ...
    if strcmp(varname,'SST'),
        ...
        pic_otds(3,:) = nanmean(other_ds.hadisst2.ts(:,pic_t - other_ds.hadisst2.time(1) + 1,reg),1);
    ...
    if strcmp(varname,'SST'),
        CDF_patch(pic_t,pic_otds_rnd,[.6 .6 .6],0.0455);
        CDF_patch(pic_t,pic,[.6 .7 1],0.05);
    end
